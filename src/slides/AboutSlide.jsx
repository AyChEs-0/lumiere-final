...
const team = [
  {
    ...
    desc: 'Define objetivos, supervisa tareas y facilita la comunicación del equipo',
    color: '#d4183d',
  },
  {
    initials: 'DG',
    name: 'Danna Guevara',
    role: 'Tech Lead + Documentación',
    desc: 'Desarrolla la arquitectura, redacta documentación técnica y asegura código limpio',
    color: '#9333ea',
  },
  {
    initials: 'IA',
    ...
    role: 'QA + Frontend',
    desc: 'Revisa buenas prácticas, pruebas funcionales y supervisa la usabilidad',
    color: '#0891b2',
  },
]
