...
const team = [
  {
    ...
    desc: 'Definició d\'objectius, supervisió del tauler Trello, integració dels mòduls i coherència visual. Responsable de les decisions de prioritat i de la comunicació entre membres.',
    color: '#d4183d',
  },
  {
    initials: 'DG',
    ...
    desc: 'Arquitectura del sistema, configuració de l\'entorn Docker compartit, redacció de tots els informes de seguiment i validació, i gestió del desplegament a Railway.',
    color: '#9333ea',
  },
  {
    initials: 'IA',
    ...
    role: 'QA + Frontend',
    desc: 'Revisió de bones pràctiques, proves funcionals de tots els mòduls, supervisió d\'accessibilitat i usabilitat, i validació del flux complet de reserva.',
    color: '#0891b2',
  },
]
