...
const encerts = [
  ...
  'El fallback TMDB → BD local va evitar un punt únic de fallada crític en producció',
...
const millores = [
  ...
  'Hauríem escrit tests des del principi, no al final — els tests van descobrir inconsistències',
    ...
    <div className="w-full h-full flex flex-col justify-center px-[8vw] py-10">
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-6">
          <motion.div {...fadeUp(0.3)} className="glass rounded-2xl p-7 flex flex-col gap-5"
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.18em] text-[#16a34a]">Que va funcionar</span>
            </div>
          ...
          <motion.div {...fadeUp(0.38)} className="glass rounded-2xl p-7 flex flex-col gap-5"
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.18em] text-[#d97706]">Que millorariem</span>
            </div>
